...
const EditBengkel = () => {
     ...
     const updateUser = async (e) => {
          e.preventDefault();
          try {
               await axiosInstance.patch(`/databengkel/${id}`, {
                    name,
                    alamat,
                    telepon,
                    fasilitas,
               ...
               <div className=" w-full max-w-xs">
                    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={updateUser}>
                         ...
                         <div className="mb-6">
                              ...
                              <input className="shadow appearance-none border rounded w-6/12 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" value={buka} onChange={(e) => setBuka(e.target.value)} type="text" placeholder="Buka" />
                              <input className="shadow appearance-none border rounded w-6/12 py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" value={tutup} onChange={(e) => setTutup(e.target.value)} type="text" placeholder="Tutup" />
                         </div>
                         <div className="mb-6">
                              <label className="block text-gray-700 text-sm font-bold mb-2">
                                   Latitude
