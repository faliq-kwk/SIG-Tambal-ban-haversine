                    ...
                    return (
                         <div key={kondang.location.id}>
                              ...
                              <button className='mt-10 mb-10 mr-2'>
                                   <a href={`/petunjukarah/${kondang.location.id}`} className='text-base font-semibold text-white bg-blue-500 py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out'>Petunjuk Arah</a>
                              </button>
                         </div>
                    )
               })}
